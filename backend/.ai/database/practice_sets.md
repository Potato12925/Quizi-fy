...
| `topic_id` | bigint | FK | Optional topic scope filter |
...
- A practice set can be generic by subject or narrowed to one topic.
- Question selection should use `questions.topic_id`, not `document_topic_id`.
