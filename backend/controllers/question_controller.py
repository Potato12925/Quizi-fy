...
async def post_question(payload: QuestionCreateRequest, _: CurrentUser = Depends(require_roles("admin"))):
    ...
    except QuestionSubjectInactiveError as exc:
        return error_response(message=str(exc), status_code=409, error_code="QUESTION_CREATE_SUBJECT_INACTIVE")
