...
async def get_teacher_question_bank_route(
    ...
    try:
        ...
        return success_response(
            ...
            message="Teacher question bank loaded successfully",
            status_code=200,
        )
        ...
        return error_response(
            message=str(exc),
            status_code=500,
            error_code="TEACHER_QUESTION_BANK_LIST_FAILED",
        )
...
async def get_teacher_document_topic_options_route(
    ...
    try:
        ...
        return success_response(
            data=result,
            message="Document topic options loaded successfully",
            status_code=200,
        )
    except Exception:
        return error_response(
            message="Unable to load document topic options",
            status_code=500,
            error_code="TEACHER_QUESTION_BANK_DOC_TOPIC_OPTIONS_FAILED",
        )
...
async def create_manual_question_route(
    ...
    try:
        ...
        return error_response(
            message=str(exc),
            status_code=403,
            error_code="TEACHER_QUESTION_BANK_CREATE_FORBIDDEN",
        )
        ...
        return error_response(
            message=str(exc),
            status_code=400,
            error_code="TEACHER_QUESTION_BANK_CREATE_INVALID",
        )
    except Exception:
        return error_response(
            message="Unable to create question",
            status_code=500,
            error_code="TEACHER_QUESTION_BANK_CREATE_FAILED",
        )
...
async def update_teacher_question_route(
    ...
    try:
        ...
        return error_response(
            message=str(exc),
            status_code=403,
            error_code="TEACHER_QUESTION_BANK_UPDATE_FORBIDDEN",
        )
    except QuestionImageValidationError as exc:
        return error_response(message=str(exc), status_code=exc.status_code, error_code=exc.error_code)
    except ValueError as exc:
        ...
        return error_response(
            ...
            error_code="TEACHER_QUESTION_BANK_UPDATE_INVALID",
        )
    except Exception:
        return error_response(
            message="Unable to update question",
            status_code=500,
            error_code="TEACHER_QUESTION_BANK_UPDATE_FAILED",
        )
...
async def update_teacher_question_status_route(
    ...
    try:
        ...
        return error_response(
            message=str(exc),
            status_code=status_code,
            error_code="TEACHER_QUESTION_BANK_STATUS_UPDATE_INVALID",
        )
    except Exception:
        return error_response(
            message="Unable to update question status",
            status_code=500,
            error_code="TEACHER_QUESTION_BANK_STATUS_UPDATE_FAILED",
        )
...
async def delete_teacher_question_route(
    ...
    try:
        ...
        return error_response(
            message=str(exc),
            status_code=status_code,
            error_code="TEACHER_QUESTION_BANK_DELETE_INVALID",
        )
    except Exception:
        return error_response(
            message="Unable to delete question",
            status_code=500,
            error_code="TEACHER_QUESTION_BANK_DELETE_FAILED",
        )
